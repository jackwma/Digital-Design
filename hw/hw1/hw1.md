# CSE 414 Homework 1: SQLITE and SQL Basics
...
`https://gitlab.cs.washington.edu/cse414-2019sp/cse414-[your UW username]`. 
...
$ git clone git@gitlab.cs.washington.edu:cse414-2019sp/cse414-[your UW username].git
...
When we created your `cse414-[your UW username]` repository, we forked a copy of it from another 
repository `cse414-2019sp`.  In `git` parlance, this "original repository" referred to as an `upstream` repository.
...
$ git remote add upstream git@gitlab.cs.washington.edu:suciu/cse414-2019sp.git
```
...
```sh
$ git remote -v
  origin  git@gitlab.cs.washington.edu:cse414-2019sp/cse414-[your UW username].git (fetch)
  origin  git@gitlab.cs.washington.edu:cse414-2019sp/cse414-[your UW username].git (push)
  upstream    git@gitlab.cs.washington.edu:suciu/cse414-2019sp.git (fetch)
  upstream    git@gitlab.cs.washington.edu:suciu/cse414-2019sp.git (push)
```
...
To git@gitlab.cs.washington.edu:cse414-2019sp/cse414-[your UW username].git
...
From gitlab.cs.washington.edu:cse414-2019sp/cse414-2019sp
...
All CSE 414 assignments are to be completed **INDIVIDUALLY**! However, you may discuss your high-level approach to solving each lab with other students in the class.
...
To git@gitlab.com:cse414-2019sp/cse414-[your UW username].git
 - [deleted]         hw1
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse414-2019sp/cse414-[your UW username].git confirmation_directory
